...
$runName = "omni_collective_v46_chat_bench_repair_evo3h"
...
$pythonArgs = @(
    ...
    ('"{0}"' -f $latestV8Summary)
    "--output_root"
    "output\omni_collective_v46_chat_bench_repair_evo3h_prep"
    "--output_dir"
    "output\omni_collective_v46_chat_bench_repair_evo3h_train"
    "--family_name"
    "omni_collective_v46_chat_bench_repair_evo3h"
    "--artifact_prefix"
    "supermix_omni_collective_v46_chat_bench_repair_evo3h"
    "--seed"
    "2028"
    "--benchmark_limit"
    "128"
...
[pscustomobject]@{
    ...
    benchmark_failure_replay_limit = 720
    cognitive_evolution_limit = 520
    chat_repair = "direct chat-drift repair + normal-chat retention"
    weak_suite_replay = "gsm8k + arc_challenge + mmlu oversampling"
