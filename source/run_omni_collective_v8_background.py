...
import train_omni_collective_v8
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Background launcher for omni_collective_v8 with in-process log teeing.")
...
def main() -> None:
    ...
    try:
        ...
        sys.argv = ["train_omni_collective_v8.py"] + train_args
        train_omni_collective_v8.main()
    except Exception:
        traceback.print_exc()
        raise
    finally:
