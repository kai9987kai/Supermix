...
$runName = "omni_collective_v46_allbench_cachefloor_evo4h"
...
$pythonArgs = @(
    ...
    ('"{0}"' -f $latestV8Summary)
    "--output_root"
    "output\omni_collective_v46_allbench_cachefloor_evo4h_prep"
    "--output_dir"
    "output\omni_collective_v46_allbench_cachefloor_evo4h_train"
    "--family_name"
    "omni_collective_v46_allbench_cachefloor_evo4h"
    "--artifact_prefix"
    "supermix_omni_collective_v46_allbench_cachefloor_evo4h"
    "--seed"
    "2054"
    "--benchmark_limit"
    "200"
...
[pscustomobject]@{
    ...
    strategy = "champion warm-start + exact benchmark anchor cache + suite-best union rows + weak-suite hard negatives + Pareto non-regression floor"
    ...
    suite_best_anchor_limit = 2600
    hard_benchmark_limit = 1100
    weak_suite_targets = "bbh, commonsenseqa, openbookqa, winogrande, plus exact floors for every 10-suite benchmark item"
