...
$runName = "omni_collective_v46_bbh_hard_evo4h"
...
$pythonArgs = @(
    ...
    ('"{0}"' -f $latestV8Summary)
    "--output_root"
    "output\omni_collective_v46_bbh_hard_evo4h_prep"
    "--output_dir"
    "output\omni_collective_v46_bbh_hard_evo4h_train"
    "--family_name"
    "omni_collective_v46_bbh_hard_evo4h"
    "--artifact_prefix"
    "supermix_omni_collective_v46_bbh_hard_evo4h"
    "--seed"
    "2031"
    "--benchmark_limit"
    "144"
...
[pscustomobject]@{
    ...
    benchmark_failure_replay_limit = 1200
    hard_benchmark_limit = 260
    cognitive_evolution_limit = 720
    adaptive_suite_replay = "latest benchmark scores drive weak-suite sampling, now including BBH"
    hard_negative_repair = "numeric GSM8K + multiple-choice/BBH wrong-answer rejection"
    champion_archive = "pareto elite success retention from the promoted 101/120 branch"
