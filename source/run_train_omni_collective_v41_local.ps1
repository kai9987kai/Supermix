...
$outLog = Join-Path $logDir "omni_collective_v41_train_${timestamp}.out.log"
$errLog = Join-Path $logDir "omni_collective_v41_train_${timestamp}.err.log"
$pidPath = Join-Path $logDir "omni_collective_v41_train.pid"
$workerPidPath = Join-Path $logDir "omni_collective_v41_train.worker.pid"
...
$pythonArgs = @(
    "-u"
    "source\train_omni_collective_v41.py"
    "--train_frontier"
) + $args
