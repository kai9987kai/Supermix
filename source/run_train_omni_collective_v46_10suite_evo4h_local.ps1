...
$runName = "omni_collective_v46_10suite_evo4h"
...
$pythonArgs = @(
    ...
    ('"{0}"' -f $latestV8Summary)
    "--output_root"
    "output\omni_collective_v46_10suite_evo4h_prep"
    "--output_dir"
    "output\omni_collective_v46_10suite_evo4h_train"
    "--family_name"
    "omni_collective_v46_10suite_evo4h"
    "--artifact_prefix"
    "supermix_omni_collective_v46_10suite_evo4h"
    "--seed"
    "2033"
    "--benchmark_limit"
    "160"
...
[pscustomobject]@{
    ...
    benchmark_failure_replay_limit = 1800
    hard_benchmark_limit = 420
    cognitive_evolution_limit = 880
    adaptive_suite_replay = "latest 10-suite scores drive weak-suite sampling"
    weak_suite_targets = "commonsenseqa, winogrande, bbh, openbookqa"
    hard_negative_repair = "numeric GSM8K + all multiple-choice wrong-answer rejection"
    champion_archive = "pareto elite success retention from the promoted 10-suite baseline branch"
