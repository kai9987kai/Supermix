...
$logDir = Join-Path $repoRoot "output\omni_collective_v46_coevo180_train"
New-Item -ItemType Directory -Force -Path $logDir | Out-Null

$timestamp = Get-Date -Format "yyyyMMdd_HHmmss"
$outLog = Join-Path $logDir "omni_collective_v46_coevo180_${timestamp}.out.log"
$errLog = Join-Path $logDir "omni_collective_v46_coevo180_${timestamp}.err.log"
$pidPath = Join-Path $logDir "omni_collective_v46_coevo180.pid"
$workerPidPath = Join-Path $logDir "omni_collective_v46_coevo180.worker.pid"
...
# This schedule targets roughly a three-hour follow-on pass on the current CPU setup.
$stage1Epochs = 2
$stage2Epochs = 1
...
$pythonArgs = @(
    ...
    ('"{0}"' -f $latestV8Summary)
    "--output_root"
    "output\omni_collective_v46_coevo180_prep"
    "--output_dir"
    "output\omni_collective_v46_coevo180_train"
    "--family_name"
    "omni_collective_v46_coevo180"
    "--artifact_prefix"
    "supermix_omni_collective_v46_coevo180"
    "--seed"
    "1373"
    "--benchmark_limit"
    "88"
