...
<div class='wrap'>
  <aside class='panel'>
    ...
    <div class='split'><div class='row'><label for='stabilityPatience'>Stability patience</label><input id='stabilityPatience' type='number' min='0' max='64' step='1' value='2'></div><div class='row'><label for='stabilityMargin'>Stability margin</label><input id='stabilityMargin' type='number' min='0' step='0.0001' value='0.0005' title='v51 checkpoint/workload-calibrated default; explicit overrides are supported'></div></div>
